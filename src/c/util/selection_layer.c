...
// Modified to support up to 16 cells
...
#define DEFAULT_INACTIVE_COLOR PBL_IF_COLOR_ELSE(GColorLightGray, GColorBlack)
...
Layer* selection_layer_create(GRect frame, int num_cells) {
  return selection_layer_init(NULL, frame, num_cells);
}
